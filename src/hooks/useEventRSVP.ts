...
// This naming follows the mixed-case format that some imports are using
...
// Add a named export using the uppercase version for backward compatibility
export const useEventRSVP = useEventRsvp;

// For default exports - support both naming conventions
