...
// Define vibe options with colors and icons
...
export default function EventVibeLabel({
  vibe,
  size = "md",
  className,
  showIcon = true,
  ...
  // Only show icon on large size unless explicitly requested
  const displayIcon = showIcon && (size === "lg" || size === "md");
