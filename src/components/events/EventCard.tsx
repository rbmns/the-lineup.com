...
export const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    ...
    >
      {/* Image with vibe label and category text */}
      <div className="relative w-full h-48 sm:h-52 overflow-hidden bg-gray-100 flex-shrink-0">
        ...
        {/* Category as simple text - bottom left */}
        {event.event_category && (
          <div className="absolute bottom-3 left-3 z-10">
            <span className="text-white text-sm font-medium px-2.5 py-1 bg-black/40 backdrop-blur-sm rounded-md">
              {event.event_category}
            </span>
          </div>
        )}
