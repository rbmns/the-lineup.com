...
export const EventsPageLayout: React.FC<EventsPageLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-white">
      {/* Header Section - Brand styling with gradient background */}
      <div className="relative w-full main-feed-gradient border-b border-gray-200">
      ...
      <div className="w-full main-feed-gradient">
