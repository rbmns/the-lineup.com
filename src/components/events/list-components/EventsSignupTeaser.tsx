...
export const EventsSignupTeaser: React.FC = () => {
  ...
  return <div className="w-full py-8 my-8 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg border border-purple-100">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
        ...
        <div className="flex mt-2 sm:mt-0">
          <Button variant="default" onClick={handleSignUp} className="px-5 bg-cyan-200 hover:bg-cyan-100">
            Sign up
          </Button>
        </div>
      </div>
