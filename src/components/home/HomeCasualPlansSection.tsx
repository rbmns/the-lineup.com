  ...
  return (
    <section className="py-8 md:py-12">
      <div className="space-y-6 md:space-y-8">
        {/* Header */}
        <div>
          <h2 className={`${typography.h2} mb-4`}>Create Spontaneous Plans</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
            <div className="text-center md:text-left">
              <p className={`${typography.body} font-medium`}>Coffee chats, beach walks, local explorations</p>
            </div>
            <div className="text-center md:text-left">
              <p className={`${typography.body} font-medium`}>Last-minute plans and spontaneous activities</p>
            </div>
            <div className="text-center md:text-left">
              <p className={`${typography.body} font-medium`}>Connect with locals and travelers nearby</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <h3 className={`${typography.h3}`}>Recent Casual Plans</h3>
