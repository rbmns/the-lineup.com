...
const HomePageHeaderSection = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 m-0 p-0 pb-12 pt-12 md:pb-24 md:pt-20">
      <div className="w-full text-center text-white px-4 sm:px-6 lg:px-8">
        <h1 className={`${isMobile ? 'text-3xl' : 'text-4xl md:text-5xl lg:text-6xl'} font-bold tracking-tight text-white mb-4`}>
          Find events that fit your <span className="text-yellow-300 font-handwritten">vibe</span>
        </h1>
        <p className={`${isMobile ? 'text-base' : 'text-lg md:text-xl lg:text-2xl'} text-white/90 max-w-3xl mx-auto leading-relaxed`}>
